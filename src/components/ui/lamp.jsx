    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        <motion.div
          ...
          style={{
            backgroundImage: `conic-gradient(from 70deg at center top, #eab308 0%, transparent 50%, transparent 100%)`,
          }}
        ...
        <motion.div
          ...
          style={{
            backgroundImage: `conic-gradient(from 290deg at center top, transparent 0%, transparent 50%, #eab308 100%)`,
          }}
